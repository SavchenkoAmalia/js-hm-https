...
},{"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/fetchCountries.js":[function(require,module,exports) {
"use strict";
...
function fetchCountries(name) {
  ...
  var params = '?fields=name,capital,population,flags,languages';
  return fetch("".concat(BASE_URL).concat(name).concat(params)).then(function (response) {
    if (!response.ok) {
...
},{"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/@pnotify/core/dist/BrightTheme.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/script.js":[function(require,module,exports) {
"use strict";
...
var infoEl = document.getElementById('country-info');
inputEl.addEventListener('input', (0, _lodash.default)(onSearch, 500));
function onSearch(e) {
...
function renderCountryList(countries) {
  var markup = countries.map(function (country) {
    return "<li><img src=\"".concat(country.flags.svg, "\" alt=\"Flag\" width=\"30\" /> ").concat(country.name, "</li>");
  }).join('');
  listEl.innerHTML = "<ul>".concat(markup, "</ul>");
}
function renderCountryInfo(country) {
  var languages = country.languages.map(function (lang) {
    return lang.name;
  }).join(', ');
  infoEl.innerHTML = "\n    <h2>".concat(country.name, "</h2>\n    <img src=\"").concat(country.flags.svg, "\" alt=\"Flag\" />\n    <p><strong>Capital:</strong> ").concat(country.capital, "</p>\n    <p><strong>Population:</strong> ").concat(country.population, "</p>\n    <p><strong>Languages:</strong> ").concat(languages, "</p>\n  ");
}
function clearResults() {
  listEl.innerHTML = '';
  infoEl.innerHTML = '';
}
},{"../css/style.css":"css/style.css","./fetchCountries":"js/fetchCountries.js","lodash.debounce":"node_modules/lodash.debounce/index.js","@pnotify/core":"node_modules/@pnotify/core/dist/PNotify.js","@pnotify/core/dist/PNotify.css":"node_modules/@pnotify/core/dist/PNotify.css","@pnotify/core/dist/BrightTheme.css":"node_modules/@pnotify/core/dist/BrightTheme.css"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "54630" + '/');
